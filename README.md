...
flowchart TD
    %% === Main Flow ===
    A["🤖 **Artificial Intelligence (AI):** Making machines think and act smartly like humans"]
        --> B["📘 **Machine Learning (ML):** Teaching computers to learn from examples instead of direct instructions"]

    B --> C["🧠 **Neural Networks:** Brain-like systems that help computers think and learn"]
    C --> D["💬 **Natural Language Processing (NLP):** Helps computers understand and use human language"]

    %% === NLP Details ===
    D --> E["✂️ **Tokenization:** Breaking sentences into smaller words or parts"]
    E --> F["🧩 **Parsing:** Understanding sentence structure (who did what)"]
    D --> G["😊 **Sentiment Analysis:** Finding emotions in text (happy, sad, etc.)"]
    D --> H["🗣️ **Prompting:** Giving instructions to guide AI responses"]

    %% === Learning Types ===
    B --> I["👩‍🏫 **Supervised Learning:** Learning from labeled data with correct answers"]
    B --> J["🎲 **Unsupervised Learning:** Finding patterns in data without labels"]
    B --> K["🏆 **Reinforcement Learning:** Learning by trial and error with rewards"]
    B --> L["🌊 **Deep Learning:** Advanced learning using many layers for complex data"]

    %% === Advanced Learning Methods ===
    L --> M["🎮 **Zero-Shot Learning:** Solving new problems never seen before"]
